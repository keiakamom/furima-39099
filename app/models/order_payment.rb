class OrderPayment
  ...
  def save
    ...
    Payment.create(postcode: postcode, prefecture_id: prefecture_id, city: city, adresses: adresses, building: building, phone_number: phone_number, order_id: order.id)
  end
end